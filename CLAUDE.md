...
### 🔴 P0: 外部情报系统（grill-me 确立）

用户作为家庭 CFO，需要系统感知外部环境，不只是内视。

**需求**：
- 每日自动简报：市场行情 + 宏观政策，DeepSeek 摘要出 3 条和家庭相关的内容
- 随时追问：看板/企微输入框，问"最近房市对我们家有影响吗"
- 主动预警：高置信度风险（政策突变、市场暴跌）推送到企微，中低置信度放看板
- 双通道：企微推送 + 网页看板

**数据源**：akshare 已有行情，政策类信息获取方式待定
**AI 角色**：摘要 + 推理 + 家庭相关性过滤
